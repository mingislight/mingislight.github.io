...
image: /assets/img/azure-outage.png
description: "A reflection on the October 29 Azure outage, why hybrid architecture matters, and the foundation Jesus Christ teaches us to build on."
...
On October 29, 2025, Azure, Azure, Microsoft's cloud platform, cloud services went down.

Not a small slowdown.

A full outage across multiple regions.

In the same month, AWS, Amazon's cloud platform, also had a major outage.

Different provider. Different cause. Same message.

No cloud is unbreakable.

For us in healthcare IT, everything shook.

Our medical record system went down.
...
The quiet IT support that grows with demand and updates automatically.

But outages like this show a simple truth:

Cloud alone is convenient, but it is not complete.
...
A private cloud is the systems we control in our own servers and systems.

A public cloud, like Azure or AWS, gives us scale and speed.

Together they provide what neither can give alone.

Private systems keep data safe and under control. 

Public systems add flexibility and room to grow.

Patient care cannot depend on one location or one vendor.
